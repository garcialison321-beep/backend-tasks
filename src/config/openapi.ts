...
export const openApiSpec = swaggerJsdoc({
  definition: {
    ...
    servers: [
      ...
      {
        url: "https://backend-tasks-api.onrender.com/api/v1",
    ...
    tags: [
      ...
      { name: "Tasks", description: "Endpoints de tareas" },
      { name: "Tags", description: "Endpoints de tags" },
      { name: "Notifications", description: "Endpoints de notificaciones" },
      { name: "Attachments", description: "Endpoints de attachments" },
      { name: "ActivityLogs", description: "Endpoints de activity logs" },
    ],
